...
<div className="navbar-center hidden lg:flex">
  ...
  <input type="checkbox" data-toggle-theme="dark,light" data-act-class="ACTIVECLASS" className="theme-controller" value="synthwave" />
  ...
  {auth.user ? (
    <button onClick={signOut} className="px-4 py-2 btn btn-primary">Logout</button>
  ) : (
    <Link to="/login" className="px-4 py-2 btn btn-primary">Login</Link>
  )}
</div>
      </div>
  )
